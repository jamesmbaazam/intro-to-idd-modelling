...
- Mathematical models often have three main purposes in infectious disease epidemiology:
  - To understand the spread and dynamics of infectious diseases
  - To predict the future course of an outbreak
  - To evaluate the impact of interventions and determine the next course of action

# Deterministic compartmental models

## What are compartmental models?

- Compartmental models are a type of mathematical model used to describe the
spread of infectious diseases in a population.
...
- In compartmental models, individuals move between compartments based on defined
...
- Other compartments can be added to the model to account for important events or
processes (e.g., exposed, recovered, vaccinated, etc.)

- It is, however, important to keep the model simple, less computationally
intensive, and interpretable.
